    ...
    <div className="min-h-screen bg-gray-50 font-sans" dir="rtl">
      ...
      <div className="bg-blue-600 text-white pt-20 pb-24 rounded-b-[3rem] shadow-xl px-4 text-center relative overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          <p className="text-lg text-blue-100 mb-10 max-w-xl mx-auto">
            المنصة الأحدث والأكثر أماناً في الكويت. آلاف الإعلانات بانتظارك.
          </p>
      ...
      <div className="container mx-auto px-4 mt-16 mb-12">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          {categories.map((cat) => (
            <div
              key={cat.name}
              className={`p-4 rounded-xl border border-gray-100 shadow-sm hover:shadow-md transition cursor-pointer flex items-center gap-3 bg-white group`}
            >
              <div
                className={`w-10 h-10 rounded-full flex items-center justify-center ${cat.color} group-hover:scale-110 transition`}
              >
                #
              </div>
      ...
      <main className="container mx-auto px-4 pb-20">
        <div className="flex items-center justify-between mb-8">
          ...
          <Link href="/search" className="text-blue-600 font-bold hover:underline flex items-center gap-1 text-sm">
